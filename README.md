...
### [Decomposition vs Augmentation](https://github.com/Fritozz-105/decomposition-vs-augmentation)

Research comparing classical, single-LLM, and multi-agent approaches to entity resolution.

### [SwampFindr](https://github.com/Fritozz-105/SwampFindr)

An AI-powered apartment search platform that helps University of Florida students find housing using natural-language queries.

### [LockedIn](https://github.com/Fritozz-105/LockedIn)

A mobile health and fitness tracker built with React Native, Fastify, PostgreSQL, and TypeScript.
...
<a href="https://www.heroku.com/"><img src="https://www.vectorlogo.zone/logos/heroku/heroku-icon.svg" alt="Heroku" width="40" height="40"/></a>
</p>
